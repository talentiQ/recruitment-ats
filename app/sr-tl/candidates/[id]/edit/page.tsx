// app/sr-tl/candidates/[id]/edit/page.tsx
'use client'
...
export default function SrTLEditCandidatePage() {
  ...
  const loadCandidate = async () => {
    try {
      ...
      console.log('✅ Sr.TL: Candidate loaded:', data.full_name)
      setCandidate(data)
    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <AddCandidateForm
          ...
          redirectPath={`/sr-tl/candidates/${candidateId}`}
