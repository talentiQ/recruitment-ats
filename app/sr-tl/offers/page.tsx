      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Complete overview of offers and placement safety monitoring</p>
          </div>
        </div>
          ...
          <div className="card bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">
                🛡️ Team Placement Safety Monitor
              </h3>
                        ...
                        <div className="mt-3 p-3 bg-red-100 border-2 border-red-300 rounded-lg">
                          <div className="flex items-center gap-2 text-red-900">
                            ...
                            <div className="text-sm">
                              <strong>URGENT ACTION REQUIRED:</strong> Only {offer.daysRemaining} day{offer.daysRemaining !== 1 ? 's' : ''} left in guarantee period! 
