...
import RenegeModal from '@/components/RenegeModal'
...
export default function OfferDetailPage() {
  ...
  const expectedRevenue = (offer.fixed_ctc * 0.0833).toFixed(2)
    ...
    <DashboardLayout>
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-yellow-50 rounded-lg">
              ...
              <div className="text-2xl font-bold text-yellow-900">₹{offer.variable_ctc || 0}L</div>
            </div>
      ...
      {showRenegeModal && (
        <RenegeModal
          ...
          onCancel={() => setShowRenegeModal(false)}
        />
      )}
    </DashboardLayout>
  )
