    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <StatCard label="Total CVs" value={stats.totalCandidates} color="blue" loading={loading} />
          <StatCard label="Sourced" value={stats.sourced} color="gray" loading={loading} />
          <StatCard label="Screening" value={stats.screening} color="yellow" loading={loading} />
          <StatCard label="Interview" value={stats.interview} color="purple" loading={loading} />
          <StatCard label="Offered" value={stats.offered} color="indigo" loading={loading} />
          <StatCard label="Joined" value={stats.joined} color="green" loading={loading} />
        </div>
...
function StatCard({
  ...
  return (
    <div
      className={`${colors[color as keyof typeof colors]} border rounded-lg p-4`}
    >
